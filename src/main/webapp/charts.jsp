		...
		<div class="sidebar">
            ...
            <ul>
              ...
              <li><a href="#">Submenu #3</a></li>
				...
				<li><a href="charts.html" class="open"><i
						class="icon-bar-chart"></i> Charts</a></li>
									...
									<div class="padd">
										...
										<div class="btn-group stackControls">
											<input type="button" value="With stacking"
												...
												value="Without stacking" class="btn btn-default">
										</div>
							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="padd">
										...
										<hr />
										Time Inverval: <input id="updateInterval" type="text"
											class="span3" value="">
